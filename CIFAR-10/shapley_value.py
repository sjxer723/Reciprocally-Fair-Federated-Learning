...
# fl = FLInstance(7, [1 for _ in range(7)], 10, 1)
# fl.update_s({0:1, 1: 100, 2:1, 3:1, 4:1, 5:1, 6:1})
# shapley_val = fl.compute_shapley_values(1)
# print(shapley_val)
# shapley_val = fl.compute_shapley_values(0)
# print(shapley_val)